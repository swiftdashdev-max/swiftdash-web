      ...
      <div className="max-w-screen-2xl mx-auto flex">
        ...
        <main className="flex-1 min-w-0 px-6 md:px-10 lg:px-16 pb-32">
          ...
          <Section id="introduction" title="Introduction">
            ...
            {/* Emergency reporting is a separate product with a separate
                audience. It gets a pointer from here, not a section — mixing the
                two references would make both harder to read. */}
            <Link
              href="/docs/emergency"
              className="mt-4 flex items-center justify-between gap-4 rounded-lg border border-red-500/25 bg-red-500/5 px-4 py-3.5 transition-colors hover:border-red-500/50"
            >
              <div>
                <p className="text-sm font-semibold text-foreground">Emergency Response API</p>
                <p className="mt-0.5 text-xs leading-relaxed text-muted-foreground">
                  Separate reference for command centers &mdash; file emergency reports, follow the
                  response, cancel a call.
                </p>
              </div>
